...
if (session_status() == PHP_SESSION_ACTIVE) {
    echo ("<h1>" . $_SESSION['message'] . "</h1>"); //per stampare messaggio di errore
    session_destroy();
}
?>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Accedi</h6>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <form method="post" action="SitoGuardia.php">
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="email" class="form-control bg-light border-0 px-4" placeholder=" Email"
